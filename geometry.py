...
class LineSegment(object):
    ...
    def __init__(self, start, end):
        ...
        if self.length > 0.0:
            ...
            # print(unit_x,unit_y) # debug
            self.unit_vector = Point(unit_x, unit_y)
            # print(self.unit_vector.x) # debug
        # else:
    ...
    def sine_of_angle_with(self, other_line_segment):
        ...
        if not (other_line_segment.unit_vector.x):
            print("THIS IS ERRORRRRRRRRRRRRR NOT FOUND unit_vector")
        # print(other_line_segment.unit_vector.x)
        # print(other_line_segment.length)

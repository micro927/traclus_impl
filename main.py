...
output_folder = 'OUTPUT_SP'
input_folder = 'INPUT_SP'
input_name = 'SP_09112018day' + '.json'

input_file = input_folder + '/' + input_name
output_file = output_folder + '/OUTPUT_' + input_name

input_file = 'data/input_master_ss.json' #set input folder/name manually
# output_file = '' #set output folder/name manually
